                        ...
                        <div className="container">
                            <div id='authForm'>
                                <Form
                                    ...
                                    <p onClick={this.changeVisibility} style={{ fontSize: '14px', float: 'right'}}><Link as={Link} to="/pw-reset">Reset password</Link> </p> <br/>

                                    <Button disabled={invalid} type="submit" variant="warning" className='authInputs'>
                                        Login
                                    </Button>
                                    <p onClick={this.changeVisibility} style={{ fontSize: '14px' }}>Don't have an account? <Link as={Link} to="/register">Register</Link> for free:)</p>
                                </Form>
